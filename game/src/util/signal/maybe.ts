...
export const maybeKey: MaybeKeyCall = <O extends Object, Key extends keyof O>(keyOf: Key) => isNotNothing(key(keyOf)) as Listen<Maybe<O[Key]>, Maybe<O>>

export const maybeSelect = <V1, Filter extends V1 & (null | undefined), From extends Exclude<V1, Filter>, To>(mapping: Function1<From, To>): Listen<To | Filter, From | V1> => {
