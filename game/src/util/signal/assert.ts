...
export const isNothing = assert((value: any): value is undefined | null => value === undefined || value === null, 'Value is not nothing')
export const isNotNothing = assert((value: any): value is NonNullable<any> => value !== undefined && value !== null, 'Value is nothing')
export const isNumber = assert((value: any): value is number => typeof value === 'number', 'Value is not a number')
export const isArray = assert((value: any): value is any[] => Array.isArray(value), 'Value is not an array')
export const isBoolean = assert((value: any): value is boolean => typeof value === 'boolean', 'Value is not a boolean')
export const isString = assert((value: any): value is string => typeof value === 'string', 'Value is not a string')
export const isFunction = assert((value: any): value is Function => typeof value === 'function', 'Value is not a function')
export const isObject = assert((value: any): value is object => typeof value === 'object', 'Value is not an object')
export const isError = assert((value: any): value is Error => value instanceof Error, 'Value is not an error')
export const isNotNumber = assert((value: any): value is Exclude<any, number> => typeof value !== 'number', 'Value is a number')
export const isNotArray = assert((value: any): value is Exclude<any, any[]> => !Array.isArray(value), 'Value is an array')
export const isNotBoolean = assert((value: any): value is Exclude<any, boolean> => typeof value !== 'boolean', 'Value is a boolean')
export const isNotString = assert((value: any): value is Exclude<any, string> => typeof value !== 'string', 'Value is a string')
export const isNotFunction = assert((value: any): value is Exclude<any, Function> => typeof value !== 'function', 'Value is a function')
export const isNotObject = assert((value: any): value is Exclude<any, object> => typeof value !== 'object', 'Value is an object')
export const isNotError = assert((value: any): value is Exclude<any, Error> => !(value instanceof Error), 'Value is an error')
