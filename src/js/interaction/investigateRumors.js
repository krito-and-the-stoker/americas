...
const options = [{
	...
	text: ({ random }) => `Your expedition enters a small friendly tribe. The chief offers you a gift worth **${Math.round(100 + 400*random)}**<good>gold</good>.`,
	...
	text: ({ random }) => `You find the ruins of a lost civilization. Within are gold and artifacts worth **${Math.round(2000 + 5000*random)}**<good>gold</good>.`,
	action: ({ random, unit }) => {
